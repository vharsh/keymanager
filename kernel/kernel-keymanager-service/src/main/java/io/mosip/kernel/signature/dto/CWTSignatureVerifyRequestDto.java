...
@NoArgsConstructor
@AllArgsConstructor
public class CWTSignatureVerifyRequestDto {

    @NotBlank
    @ApiModelProperty(notes = "CWT Signature data to verify data should be encoded with base45", example = "eyJhbGciOiJIU.ewogICAiYW55S2V.5IjogIlRlc3QgSnNvbiIKfQ", required = true)
